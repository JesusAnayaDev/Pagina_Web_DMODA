  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
    <div class="container-fluid">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="javascript:void(0)">Material Dashboard</a>
      </div>
  ...
  <div class="page-header clear-filter">
    ...
    <div class="content-center">
      <div class="col-md-8 ml-auto mr-auto">
        <div class="brand">
          <h1 class="title">
          Bienvenido <br><?php echo $user['nombre']?>
          <?php echo $user['apellido']  ?>
          </h1>
          <h3 class="description">Estas En Modo Administrador</h3>
          <br />
          <a href="../examples/dashboard.php" class="btn btn-primary btn-round btn-lg">Panel de Administracion</a>
        </div>
      </div>
    </div>
  </div>
